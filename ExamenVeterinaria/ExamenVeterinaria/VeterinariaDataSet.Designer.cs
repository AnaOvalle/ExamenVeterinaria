...
namespace ExamenVeterinaria {
    ...
    public partial class VeterinariaDataSet : global::System.Data.DataSet {
        ...
        public partial class EspecieDataTable : global::System.Data.TypedTableBase<EspecieRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EspecieRow AddEspecieRow(string TipoEspecie) {
            ...
            private void InitClass() {
                ...
                this.columnTipoEspecie.AllowDBNull = false;
                this.columnTipoEspecie.MaxLength = 50;
            }
        ...
        public partial class EspecieRow : global::System.Data.DataRow {
            ...
            public string TipoEspecie {
                get {
                    return ((string)(this[this.tableEspecie.TipoEspecieColumn]));
                }
                set {
                    this[this.tableEspecie.TipoEspecieColumn] = value;
                }
            }
        }
...
namespace ExamenVeterinaria.VeterinariaDataSetTableAdapters {
    ...
    public partial class EspecieTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("TipoEspecie", "TipoEspecie");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Especie] ([TipoEspecie]) VALUES (@TipoEspecie)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TipoEspecie", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TipoEspecie", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TipoEspecie FROM dbo.Especie";
        ...
        public virtual int Fill(VeterinariaDataSet.EspecieDataTable dataTable) {
        ...
        public virtual VeterinariaDataSet.EspecieDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            VeterinariaDataSet.EspecieDataTable dataTable = new VeterinariaDataSet.EspecieDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(VeterinariaDataSet.EspecieDataTable dataTable) {
        ...
        public virtual int Insert(string TipoEspecie) {
            if ((TipoEspecie == null)) {
                throw new global::System.ArgumentNullException("TipoEspecie");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(TipoEspecie));
            }
